...
export const productsNavigationApi = `${environment.apiUrl}/wp-json/routes/products`;
export const projectsApi = `${environment.apiUrl}/wp-json/wp/v2/project`;
export const customProjectsApi =  `${environment.apiUrl}/wp-json/pods/custom`;
export const weddingProjectsApi = `${environment.apiUrl}/wp-json/pods/weddings`;
